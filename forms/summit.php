...
<form action="" method="post" id="business-form" role="form" style="margin-top:20px;">
    <input type="hidden" name="summit-form" value="summit">
    <div class="row">
        <div class="col-sm-7 col-xs-10 form-event-main" style="background-color: #f0f0f0;opacity:0.9;padding:20px;">

         <center><div class="form-text-crm-summit" style="margin-bottom:10px;"><span class="form-text-crm-summit">Füllen Sie bitte das Antragsformular</br>aus und Sie
