...
if (!$formSubmitted) {
    ...
    <form class="pro-form" id="conference-contact-form" action="" method="post" role="form" style="background-color:transparent;">
        <input type="hidden" name="conference-contact" value="conference-contact">
        <div class="row">
