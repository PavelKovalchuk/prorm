...
<div class="textarea-holder input-col  col">
    ...
    <textarea class="contact_<?php echo $name ?> js-float-label"  name="pro[<?php echo $name ?>]" cols="30" rows="3"  <?php if($placeholder){ ?>  placeholder="<?php echo $placeholder; ?>" <?php } ?> ><?php echo $fetcher->getData($name) ?></textarea>
