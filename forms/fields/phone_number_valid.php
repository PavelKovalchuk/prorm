...
<div class="input-phone">
    ...
    <div class="input-phone-fields">
        ...
        <input type="text" name="pro[<?php echo $name ?>][country_code]" class="pn-control-inp-cc"  title="<?php echo '1 - 2 '; _e($phone_label_digit, ProRMTheme::TEXTDOMAIN) ?>" value="<?php echo $value['country_code']; ?>">
        <span class="control-label">(</span>
        <input type="text" name="pro[<?php echo $name ?>][town_code]" class="pn-control-inp-tc"  title="<?php echo '1 - 3 '; _e($phone_label_digit, ProRMTheme::TEXTDOMAIN) ?>" value="<?php echo $value['town_code']; ?>">
        <span class="control-label">)</span>
