    ...
    sassNom: {
      ...
      dev: {
        ...
        files: [
          {
            expand: true,
            cwd: '<%= config.sassDirNom %>',
            src: ['**/*.scss', '!<%= config.sassMainFileNameNom %>.scss'],
            dest: '<%= config.cssDirNom %>',
            ext: '.css'
          },
          {src: '<%= config.sassDir %><%= config.sassMainFileNameNom %>.scss', dest: '<%= config.cssMainFileDirNom %><%= config.cssMainFileNameNom %>.css'}
        ]
      },
      dist: {
        options: {
        ...
        files: [
          ...
          {src: '<%= config.sassDirNom %><%= config.sassMainFileNameNom %>.scss', dest: '<%= config.cssMainFileDirNom %><%= config.cssMainFileNameNom %>.css'}
        ]
      },
      min: {
        options: {
        ...
        files: [
          ...
          {src: '<%= config.sassDirNom %><%= config.sassMainFileNameNom %>.scss', dest: '<%= config.cssMainFileDirNom %><%= config.cssMainFileNameNom %>.min.css'}
        ]
      }
    },
